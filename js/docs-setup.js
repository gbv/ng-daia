NG_DOCS={
  ...
  "pages": [
    ...
    },
    {
      ...
      "keywords": "angularjs api base changed code custom daia daia-api daia-filter daia-id daiaavailability daiaitem daiasimple default directive directives display document filter filtered github html identifier injected instance js ng-daia optionally parameter parameters process queries query response result scope server set source template template-url time url variable"
    },
    {
      "section": "api",
    ...
    {
      "section": "api",
      "id": "ng-daia.directive:daiaSimple",
      "shortName": "daiaSimple",
      "type": "directive",
      "moduleName": "ng-daia",
      "shortDescription": "This directive displays a DAIA response, document, or item in simplified",
      "keywords": "api changed code custom daia daia-item daiasimple default delay directive display displays document expected fields filter filtered form github href html injected item js limitation ng-daia parameter provided queue response result scope service simple simplified source template template-url url variable"
    },
    {
      "section": "api",
      "id": "ng-daia.filter:daiaSimple",
      "shortName": "daiaSimple",
      "type": "filter",
      "moduleName": "ng-daia",
